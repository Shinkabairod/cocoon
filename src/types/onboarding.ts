...
export type TimeAvailable = 'low' | 'medium' | 'high' | 'very-high';
export type LearningStyle = 'reading' | 'visual' | 'interactive' | 'community';
export type Monetization = 'yes' | 'no' | 'maybe' | 'already';
