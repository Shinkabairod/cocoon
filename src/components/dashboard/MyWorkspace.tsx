  ...
  const handleAddFolder = async () => {
    ...
    try {
      const success = await addFolder(
        ...
        newFolderEmoji, 
        newFolderColor,
        activeTab as 'personal' | 'resources'
      );
  ...
  return (
    <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    <div 
                      className="flex items-center justify-center w-12 h-12 rounded-lg border-2 cursor-pointer hover:shadow-md transition-shadow"
                      style={{ 
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                ...
                <Button 
                  ...
                  className="w-full"
                  disabled={isCreatingFile || !newFileName.trim() || !selectedFolderId}
                >
                  {isCreatingFile ? (
                    <>
                      <Loader2 className="h-4 w-4 mr-2 animate-spin" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button 
                ...
                className="flex-1"
                disabled={isMovingFile || !selectedFolderId}
              >
                {isMovingFile ? (
                  <>
                    <Loader2 className="h-4 w-4 mr-2 animate-spin" />
      ...
      <EmojiColorPicker
        ...
        currentEmoji={newFolderEmoji}
        currentColor={newFolderColor}
      />
    </div>
  );
};
