    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Créez et gérez vos boutons d'IA personnalisés
          </p>
        </div>
      ...
      <Dialog open={showEditModal} onOpenChange={setShowEditModal}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          {/* Contenu identique au modal de création */}
          <div className="space-y-6">
            {/* Informations de base */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label htmlFor="edit-name">Nom du bouton</Label>
                <Input
                  id="edit-name"
                  placeholder="Ex: Générer un script"
                  value={buttonForm.name}
            ...
            {/* Prompt */}
            <div>
              <Label htmlFor="edit-prompt">Prompt IA</Label>
              <Textarea
                id="edit-prompt"
                placeholder="Ex: Crée un script vidéo sur {sujet} pour une audience {audience}..."
                value={buttonForm.prompt}
