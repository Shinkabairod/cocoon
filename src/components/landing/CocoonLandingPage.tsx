...
const scrollingButtons = {
  row1: [
    { text: "🎥 Génère-moi un script viral TikTok", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" },
    { text: "📧 Réponds à mes emails clients", color: "from-slate-100 to-slate-200 border-slate-300 text-slate-800 hover:from-slate-200 hover:to-slate-300 hover:border-slate-400" },
    { text: "💡 Crée-moi 20 idées de contenu", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" },
    { text: "🏋️ Développe mon programme sportif", color: "from-emerald-100 to-emerald-200 border-emerald-300 text-emerald-800 hover:from-emerald-200 hover:to-emerald-300 hover:border-emerald-400" },
    ...
    { text: "📱 Automatise mes réseaux sociaux", color: "from-rose-100 to-rose-200 border-rose-300 text-rose-800 hover:from-rose-200 hover:to-rose-300 hover:border-rose-400" },
    { text: "🎯 Trouve-moi mes clients idéaux", color: "from-amber-100 to-amber-200 border-amber-300 text-amber-800 hover:from-amber-200 hover:to-amber-300 hover:border-amber-400" },
    ...
    { text: "🚀 Lance ma stratégie marketing", color: "from-amber-100 to-amber-200 border-amber-300 text-amber-800 hover:from-amber-200 hover:to-amber-300 hover:border-amber-400" },
    { text: "💻 Code-moi une landing page", color: "from-blue-100 to-blue-200 border-blue-300 text-blue-800 hover:from-blue-200 hover:to-blue-300 hover:border-blue-400" },
    { text: "📊 Analyse mes performances", color: "from-slate-100 to-slate-200 border-slate-300 text-slate-800 hover:from-slate-200 hover:to-slate-300 hover:border-slate-400" },
    { text: "🎨 Crée mes visuels de marque", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" }
  ],
  row2: [
    ...
    { text: "📚 Transforme mes idées en formation", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" },
    { text: "💬 Gère ma communauté en ligne", color: "from-rose-100 to-rose-200 border-rose-300 text-rose-800 hover:from-rose-200 hover:to-rose-300 hover:border-rose-400" },
    { text: "🎤 Écris mes scripts de podcast", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" },
    ...
    { text: "📈 Développe ma stratégie commerciale", color: "from-amber-100 to-amber-200 border-amber-300 text-amber-800 hover:from-amber-200 hover:to-amber-300 hover:border-amber-400" },
    { text: "✨ Personnalise mes workflows", color: "from-slate-100 to-slate-200 border-slate-300 text-slate-800 hover:from-slate-200 hover:to-slate-300 hover:border-slate-400" },
    { text: "🎯 Segmente ma base clients", color: "from-slate-100 to-slate-200 border-slate-300 text-slate-800 hover:from-slate-200 hover:to-slate-300 hover:border-slate-400" },
    ...
    { text: "🌟 Booste ma présence en ligne", color: "from-rose-100 to-rose-200 border-rose-300 text-rose-800 hover:from-rose-200 hover:to-rose-300 hover:border-rose-400" },
  ...
  row3: [
    { text: "⚡ Automatise mes processus business", color: "from-slate-100 to-slate-200 border-slate-300 text-slate-800 hover:from-slate-200 hover:to-slate-300 hover:border-slate-400" },
    { text: "🎨 Design mes templates marketing", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" },
    { text: "📊 Génère mes rapports mensuels", color: "from-slate-100 to-slate-200 border-slate-300 text-slate-800 hover:from-slate-200 hover:to-slate-300 hover:border-slate-400" },
    { text: "🔍 Trouve mes mots-clés SEO", color: "from-blue-100 to-blue-200 border-blue-300 text-blue-800 hover:from-blue-200 hover:to-blue-300 hover:border-blue-400" },
    ...
    { text: "🎬 Crée mes storyboards de contenu", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" },
    { text: "📋 Planifie mon calendrier éditorial", color: "from-slate-100 to-slate-200 border-slate-300 text-slate-800 hover:from-slate-200 hover:to-slate-300 hover:border-slate-400" },
    { text: "🏆 Développe ma stratégie de contenu", color: "from-amber-100 to-amber-200 border-amber-300 text-amber-800 hover:from-amber-200 hover:to-amber-300 hover:border-amber-400" },
    { text: "💡 Innove mes produits digitaux", color: "from-indigo-100 to-indigo-200 border-indigo-300 text-indigo-800 hover:from-indigo-200 hover:to-indigo-300 hover:border-indigo-400" },
    { text: "🎯 Cible mes publicités Facebook", color: "from-rose-100 to-rose-200 border-rose-300 text-rose-800 hover:from-rose-200 hover:to-rose-300 hover:border-rose-400" },
    { text: "📱 Optimise mon personal branding", color: "from-rose-100 to-rose-200 border-rose-300 text-rose-800 hover:from-rose-200 hover:to-rose-300 hover:border-rose-400" },
    { text: "💻 Crée mes outils personnalisés", color: "from-blue-100 to-blue-200 border-blue-300 text-blue-800 hover:from-blue-200 hover:to-blue-300 hover:border-blue-400" }
  ]
};
        ...
        <div className="relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Parle-en à ton IA et laisse la magie opérer!
            </p>
          </div>
