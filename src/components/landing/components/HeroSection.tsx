      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
            <span className="bg-gradient-to-r from-grey-900 via-grey-900 to-grey-900 bg-clip-text text-transparent">
              Boost et monétise
            </span>
            ...
            <span className="block mt-4 bg-gradient-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent">
              en quelques clics.
            </span>
          </h1>
