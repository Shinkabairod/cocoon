// src/components/onboarding/steps/FinalStep.tsx
import React, { useState } from 'react';
import { Button } from '@/components/ui/button';
import { useOnboarding } from '@/contexts/OnboardingContext';
import { useAuth } from '@/contexts/AuthContext';
import { useNavigate } from 'react-router-dom';
import { ArrowLeft, Sparkles, Rocket, CheckCircle, Loader2 } from 'lucide-react';
...
const FinalStep: React.FC = () => {
  ...
  const handleCreateBot = async () => {
    ...
    try {
      // Simulate API call to create the bot
      ...
      <div className="relative max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
            Perfect! Your <span className="bg-gradient-to-r from-violet-600 to-blue-600 bg-clip-text text-transparent">AI bot</span> is ready 🎉
          </h1>
          <p className="text-xl text-gray-600">Here's what we've set up for you</p>
        </div>
